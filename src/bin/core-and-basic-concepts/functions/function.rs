...
fn open_store(place: &str){ //^ here open_store function is taking the 1 parameter which is string
    println!("store is open now ...");
    println!("in the {place:}")

}

fn no_of_store(number: i32){ //^ here no_of_store function is taking the 1 parameter which is integer
    println!("store is open now ...");
