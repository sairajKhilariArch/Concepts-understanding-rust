...
// * Heap:
        ...
        // ? When the Rust program  needs dynamic space , it requests it from  the heap .a program called the memory allocator finds an empy=ty spot that is large enough to store the data....
