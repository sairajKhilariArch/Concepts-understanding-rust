// * Struct:
//              ? A Struct (structure) is a container for related data . We use structs to model complex real-world types...

//              ? Declare a struct with the struct keyword , then the name in pascal case...
